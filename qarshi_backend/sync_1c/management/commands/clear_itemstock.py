...
from sync_1c.models import ItemStock


class Command(BaseCommand):
    help = "Полная и безопасная очистка таблицы ItemStock (остатки товаров)"
